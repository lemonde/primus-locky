...
class PrimusLocky {
  constructor(primus, options) {
    ...
    this.autoLock = typeof options.locky.autoLock === 'undefined' ? true : options.locky.autoLock;
    ...
    // By default TTL - 1s.
    const heartbeatIntervalTime = options.locky.heartbeatInterval || options.locky.client.ttl - 1000;
    const heartbeatInterval = setInterval(this.refreshLocks.bind(this), heartbeatIntervalTime);
